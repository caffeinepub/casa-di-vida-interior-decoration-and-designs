...
export class Backend implements backendInterface {
    ...
    async getSubmissionsByEmail(arg0: string): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
    ...
    async getSubmissionsByProjectType(arg0: string): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubmissionsByProjectType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContact(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<boolean> {
        if (this.processError) {
            try {
